                ...
                <form class="form-horizontal" action="{{URL('admin/users')}}" method="post">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      <label for="inputEmail3" required class="col-sm-2 control-label">姓名</label>
                      <div class="col-sm-4">
                        <input type="text" name="name" class="form-control" placeholder="姓名">
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="inputPassword3" required class="col-sm-2 control-label">账号</label>
                      <div class="col-sm-4">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="password" name="repassword" class="form-control" placeholder="确定密码">
                      </div>
                    </div>
                  </div><!-- /.box-body -->
