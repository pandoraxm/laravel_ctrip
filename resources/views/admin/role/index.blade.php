            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  ...
                  <button class="btn btn-primary" onclick="window.location='{{URL('admin/role/create')}}'">添加</button
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    @foreach($list as $vo)
                        <tr>
                            ...
                            <td><button class="btn btn-xs btn-danger" onclick="doDel({{ $vo->id }})">删除</button> 
                               <button class="btn btn-xs btn-primary" onclick="window.location='{{URL('/admin/role')}}/edit?id={{ $vo->id }}'">克隆</button> 
                               <button class="btn btn-xs btn-success" onclick="loadNode({{ $vo->id }},'{{ $vo->name}}')">授权</button></td>
                        </tr>
                    @endforeach
