            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-plus"></i> 复制角色信息</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" action="{{URL('/admin/role')}}?{{ $vo->id }}" method="post">
                  ...
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <div class="col-sm-4">
                        <input type="text" name="name" readonly class="form-control" value="<?php echo $vo->name.rand(0,1000); ?>">
                      </div>
                    </div>
                    <div class="form-group">
