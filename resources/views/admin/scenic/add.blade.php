...
<body class="">
    <div class="form-group">
        <div class="col-md-4 col-md-offset-5 bt"><span class="glyphicon glyphicon-picture"></span>添加景点</div>
    </div>
    <div class="">
        <form action="/admin/scenic/add" method="post" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">

            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">名称:</div>
                <div class="col-md-3">
                    <input type="text" name="name" class="form-control input-sm" placeholder="请输入景点名称">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">价格:</div>
                <div class="col-md-3">
                    <input type="text" name="pirce" class="form-control input-sm" placeholder="请输入价格">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">时间:</div>
                <div class="col-md-3">
                    <input type="text" name="date" class="form-control input-sm" placeholder="请输入旅游时间">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">天数:</div>
                <div class="col-md-3">
                    <input type="text" name="days_num" class="form-control input-sm" placeholder="请输入天数">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                <textarea name="scontent" class="form-control" cols="30" rows="3" placeholder="请输入景点的描述" ></textarea>
                </div>
            </div>
            <div class="form-group">
