...
<body class="">
    ...
    <div class="">
        <form action="/admin/scenic/{{ $list->id }}/img_update" method="post" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">

            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">名称:</div>
                <div class="col-md-3">
                    <input type="text" name="img_name" class="form-control input-lg" placeholder="请输入名称" value="{{ $list->img_name }}">
                </div>
            </div>
            <div class="form-group">
