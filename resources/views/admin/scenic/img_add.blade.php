...
<body class="">
    <div class="form-group">
        <div class="col-md-4 col-md-offset-5 bt"><span class="glyphicon glyphicon-picture"></span>添加图片</div>
    </div>
    <div class="">
        <form action="/admin/scenic/img_add" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" name="img_name" class="form-control input-lg" placeholder="请输入名称">
                </div>
            </div>
            <div class="form-group">
