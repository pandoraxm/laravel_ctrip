...
<body class="">
    <div class="form-group">
        <div class="col-md-4 col-md-offset-5 bt"><span class="glyphicon glyphicon-pencil"></span>编辑图片</div>
    </div>
    <div class="">
        <form action="/admin/lbt/{{ $ima->id }}/update" method="post" enctype="multipart/form-data">
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">状态:</div>
                <div class="col-md-3 dbt">
                    <input type="radio" name="status" value="1" {{ ($ima->status == "1")?"checked":"" }}>显示&nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="status" value="0" {{ ($ima->status == "0")?"checked":"" }}>不显示
                </div>
            </div>
            <div class="form-group">
...
<script type="text/javascript">
    ...
    function showPrvImg(src) {
        ...
        $("#prvid img").css({ width: "300px", height: "200px" });
        }
    }
