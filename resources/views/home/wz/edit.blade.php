    ...
    <div class="form-group">
        <form action="/admin/wz" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="text" name="title" class="form-control input-lg" placeholder="请输入标题" value="{{$list->title}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">简介:</div>
                <div class="col-md-6">
                    <input type="text" name="description" class="form-control input-lg" placeholder="简介" value="{{$list->description}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">归类:</div>
                <div class="col-md-6 dbt">
                    <input type="radio" name="type" value="1" {{ ($list->type == "1")?"checked":"" }}>精华&nbsp;&nbsp;
                    <input type="radio" name="type" value="2" {{ ($list->type == "2")?"checked":"" }}>热门&nbsp;&nbsp;
                    <input type="radio" name="type" value="3" {{ ($list->type == "3")?"checked":"" }}>推荐&nbsp;&nbsp;
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">标签:</div>
                <div class="col-md-6">
                    <input type="text" name="sulg" class="form-control input-lg" placeholder="请输标签" value="{{$list->sulg}}">
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-1 col-md-offset-4 ebt">文章:</div>
                <div class="col-md-6">
                    <textarea cols=86 name="content" rows=10>{{$list->content}}</textarea>
